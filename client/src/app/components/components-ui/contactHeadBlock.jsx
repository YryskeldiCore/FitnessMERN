					...
					<div className="head-block__column">
						<div className="head-block__container">
							<h2 className="head-block__title chief-sub-title">
								Фирменный магазин Fitness
							</h2>
							<div className="head-block__time">
								Режим работы: 10:00 - 21:00
							</div>
							<div className="head-block__adress">
								Бишкек, Азия-Молл, ул. Манаса 123
							</div>
							<a
								href="mailto:fitness@fit.com"
								className="head-block__mail"
							>
								fitness@fit.com
							</a>
							<a href="tel:+996555121212" className="head-block__phone">
								+996 555 12 12 12
							</a>
					...
					{(!isLoading && !isMessage && (
						...
						(isMessage && (
							<Message
								...
								offer="Наша служба поддержки рассмотрит и свяжется с вами."
							/>
