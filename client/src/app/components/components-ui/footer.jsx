...
const Footer = () => {
	...
	const configSchema = {
		...
		phone: {
			...
			isPhone: {
				message: `Поле "Телефон" должно начинаться с 996 и иметь в своем составе только цифры`
			},
			specificAmountElements: {
				message: `Поле "Телефон" должно содержать 12 цифр, не меньше и не больше`,
				score: 12
			}
		}
	}
				...
				<div className="footer__column">
					<div className="footer__info">
						<div className="footer__phone">
							<a href="tel:+996555555555">+996 (555) 55-55-55</a> для Бишкека
						</div>
						<div className="footer__phone">
							<a href="tel:+996700707070">+996 (700) 70-70-70</a> для КР
						</div>
						<div className="footer__email">
							<a href="mailto:test@dev.com">test@dev.com</a>
						</div>
				...
				{(!isLoading && !isMessage && (
					<React.Fragment>
						...
						<div className="modal-window__text">
							...
							информацию обо всех акциях магазина Fitness.
						</div>
					</React.Fragment>
				)) ||
					(isMessage && !isLoading && (
